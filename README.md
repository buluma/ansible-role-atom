# [Ansible role atom](#ansible-role-atom)

Install atom on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-atom/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-atom/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-atom.svg)](https://github.com/buluma/ansible-role-atom/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-atom.svg)](https://github.com/buluma/ansible-role-atom/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-atom.svg)](https://github.com/buluma/ansible-role-atom/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/atom)](https://galaxy.ansible.com/ui/standalone/roles/buluma/atom/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-atom/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-atom/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-atom
